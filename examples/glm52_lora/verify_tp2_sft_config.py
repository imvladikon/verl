...
def verify_config(
    ...
    *,
    ...
    require(engine["expert_model_parallel_size"] == 1, "EP drift")
    ...
    require(data["train_batch_size"] == 1, "global batch drift")
