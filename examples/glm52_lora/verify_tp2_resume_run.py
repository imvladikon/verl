#!/usr/bin/env python3
"""Fail closed on the runtime evidence produced by the GLM-5.2 TP2 gate."""
...
def verify_run(run_dir: str | Path, expected_tokens: tuple[int, int, int] = (95, 91, 149)) -> dict[str, Any]:
    ...
    for checkpoint in (checkpoint_step2, checkpoint_step3):
        require((checkpoint / "data_0.pt").is_file(), f"dataloader state missing from {checkpoint}")
...
def main() -> None:
    ...
    parser.add_argument("--expected-tokens", default="95,91,149")
