...
install_requires = [
    ...
    # sink-less models); fixed in 5.6.1. GLM-MoE-DSA training and the matching
    # SGLang rollout are qualified together on Transformers 5.16.1.
    # See huggingface/transformers#45588.
